        ...
        <form onSubmit={submitHandler}>
            <div className="form-inner">
                ...
                <div className="form-group">
                    ...
                    <input type="text" name="phone" id="phone" onChange={e => setDetails({...details, phone: e.target.value})} value={details.phone}></input>
                </div>
                ...
                <div className="form-group">
                    ...
                    <input type="date" name="dob" id="dob" onChange={e => setDetails({...details, dob: e.target.value})} value={details.dob}></input>
                </div>
