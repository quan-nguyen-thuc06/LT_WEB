...
import {Form, Button, Row, Col, InputGroup, Grid } from 'react-bootstrap'
        ...
        return <Fragment >{data.slice(0, data.length).map((index) => {
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="edit" title="Edit" data-toggle="tooltip" onClick={() => handleEdit()} data-bs-toggle="modal" data-bs-target="#exampleModal0" name={index.id} >
            ...
            <div class="table-wrapper table-striped">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>3</td>
                            <td>Hỗ trợ ký thuật phần mềm</td>
                            <td>24/4/2022</td>
                            <td>Long An</td>
                            <td>
                                <a class="add" title="Add" data-toggle="tooltip">
